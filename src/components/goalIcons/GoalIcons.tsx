...
export const GoalIcons = () => {
  return (
    <div className="relative flex w-full transform flex-col items-center gap-12 xs:w-[120%] xs:translate-x-[10%] sm:w-[120%] sm:translate-x-[10%] md:w-[100%] md:translate-x-[0%]">
